...
export default function Services() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-white bg-gradient-to-br from-black/90 to-black/70">
        <div className="absolute inset-0 overflow-hidden opacity-20">
          <div className="absolute top-0 left-0 w-full h-full bg-[url('/images/carbonh.png')] bg-repeat opacity-80"></div>
        </div>
